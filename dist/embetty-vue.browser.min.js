...
`;function n(e,t,a,r,i,s,l,d){var c=typeof e=="function"?e.options:e;return t&&(c.render=t,c.staticRenderFns=a,c._compiled=!0),{exports:e,options:c}}var p=n({name:"EmbettyEmbed",props:{serverUrl:{type:String,required:!1,default:null}},data(){return{embettyLogo:m,fetched:!1,data:void 0}},computed:{url(){},_serverUrl(){if(this.serverUrl)return this.serverUrl;if(!this._embettyVueOptions.serverUrl)throw new Error(`serverUrl is neither set directly on the ${this.$vnode.tag} component nor globally.`);return this._embettyVueOptions.serverUrl}},watch:{url:{immediate:!0,handler(e){e&&this.fetchData()}}},methods:{fetchData(){typeof window>"u"||window.fetch(this.url).then(e=>e.json()).then(e=>{this.data=e,this.fetched=!0})},_api(e){return e?this._serverUrl+e:void 0}}},null,null);const h=p.exports,u=125,f=600,g={name:"EmbettyTweet",extends:h,props:{status:{type:String,required:!0,validator(e){return/^\d{6,}$/.test(e)}},answered:{type:Boolean,required:!1,default:!1}},data(){return{linkDescription:null}},computed:{url(){return this._api(`/tweet/${this.status}`)},userName(){return this.data.user.name},screenName(){return this.data.user.screen_name},fullText(){return this.data.full_text.replace(/(https:\/\/[^\s]+)/g,e=>this.media.length>0&&this.media[0].url===e?"":`<a href="${e}">${e}</a>`).replace(/#(\w+)/g,(e,t)=>`<a href="https://twitter.com/hashtag/${t}">${e}</a>`).replace(/@(\w+)/g,(e,t)=>`<a href="https://twitter.com/${t}">${e}</a>`)},media(){return((this.data.extended_entities||{}).media||[]).map((a,r)=>(a.imageUrl=`${this.url}-images-${r}`,a))},links(){return this.data.entities.urls||[]},link(){return this.links[0]},linkImageUrl(){return`${this.url}-link-image`},linkHostname(){const e=this.link.url.match(/^.*?\/\/(([^:/?#]*)(?::([0-9]+))?)/);return e?e[2]:void 0},profileImageUrl(){return`${this.url}-profile-image`},createdAt(){const e=this.data.created_at.replace(/\+\d{4}\s/,"");return new Date(e)},twitterUrl(){return`https://twitter.com/${this.screenName}/status/${this.data.id_str}`},answeredTweetId(){return this.data.in_reply_to_status_id_str},isReply(){return!!this.answeredTweetId}},mounted(){this.$watch("fetched",e=>{e&&this.fitLinkDescription()},{immediate:!0}),window&&window.addEventListener("resize",()=>{window.innerWidth<f||this.fitLinkDescription()})},methods:{fitLinkDescription(){if(!this.link||!window||(this.linkDescription=this.link.description,!this.linkDescription))return;const e=this.$refs.link,t=this.$refs.linkBody;if(e.clientWidth===t.clientWidth)return;const a=u;let r=0,i="";const s=window.getComputedStyle(e),l=()=>{const c=parseFloat(s.getPropertyValue("margin-top")),x=parseFloat(s.getPropertyValue("margin-bottom"));return parseFloat(s.getPropertyValue("height"))+c+x},d=()=>{r>=200||i===this.linkDescription||l()-2<=a||(i=this.linkDescription,this.linkDescription=this.linkDescription.replace(/\W*\s(\S)*$/,"…"),r++,this.$nextTick(d))};this.$nextTick(d)}}};var w=function(){var t=this,a=t._self._c;return a("div",{class:{"embetty-tweet":!0,answered:t.answered}},[t.fetched?[t.isReply?a("embetty-tweet",{attrs:{status:t.answeredTweetId,answered:!0}}):t._e(),a("header",[a("img",{attrs:{src:t.profileImageUrl}}),a("span",[a("strong",[t._v(t._s(t.userName))]),a("a",{attrs:{href:`https://twitter.com/${t.screenName}`,target:"_blank",rel:"noopener"}},[t._v("@"+t._s(t.screenName))])])]),a("article",[a("p",{domProps:{innerHTML:t._s(t.fullText)}}),t.media.length>0?a("section",{class:`media media-${t.media.length}`},t._l(t.media,function(r){return a("a",{key:r.imageUrl,attrs:{href:r.imageUrl,target:"_blank"}},[a("img",{attrs:{src:r.imageUrl}})])}),0):t._e(),t.links.length>0?a("a",{ref:"link",staticClass:"links",attrs:{href:t.link.url,target:"_blank",rel:"noopener"}},[a("img",{attrs:{src:t.linkImageUrl}}),a("section",{ref:"linkBody",staticClass:"link-body"},[a("h3",[t._v(t._s(t.link.title))]),t.linkDescription?a("p",[t._v(t._s(t.linkDescription))]):t._e(),t.linkHostname?a("span",[t._v(t._s(t.linkHostname))]):t._e()])]):t._e(),a("a",{staticClass:"created-at",attrs:{href:t.twitterUrl,target:"_blank",rel:"noopener"}},[a("time",{attrs:{datetime:t.createdAt.toISOString()}},[t._v(t._s(t.createdAt.toLocaleString()))]),t._v(" via Twitter "),a("svg",{attrs:{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 400 400"}},[a("path",{staticStyle:{fill:"#1da1f2"},attrs:{d:"M153.62,301.59c94.34,0,145.94-78.16,145.94-145.94,0-2.22,0-4.43-.15-6.63A104.36,104.36,0,0,0,325,122.47a102.38,102.38,0,0,1-29.46,8.07,51.47,51.47,0,0,0,22.55-28.37,102.79,102.79,0,0,1-32.57,12.45,51.34,51.34,0,0,0-87.41,46.78A145.62,145.62,0,0,1,92.4,107.81a51.33,51.33,0,0,0,15.88,68.47A50.91,50.91,0,0,1,85,169.86c0,.21,0,.43,0,.65a51.31,51.31,0,0,0,41.15,50.28,51.21,51.21,0,0,1-23.16.88,51.35,51.35,0,0,0,47.92,35.62,102.92,102.92,0,0,1-63.7,22A104.41,104.41,0,0,1,75,278.55a145.21,145.21,0,0,0,78.62,23"}})])]),a("a",{staticClass:"powered-by",attrs:{href:"https://www.heise.de/embetty?wt_mc=link.embetty.poweredby",target:"_blank",rel:"noopener",title:"embetty - displaying remote content without compromising your privacy."}},[t._v(" powered by "),a("span",{staticClass:"embetty-logo",domProps:{innerHTML:t._s(t.embettyLogo)}})])])]:t._e()],2)},y=[],_=n(g,w,y);const v=_.exports,o={facebook:{getVideoDataApiEndpoint(e){return`/video/facebook/${e}`},getPosterImageApiEndpoint(e){return`/video/facebook/${e}-poster-image`},getIframe(e){return`<iframe src="${`https://www.facebook.com/plugins/video.php?href=${encodeURIComponent(e.serverData.canonicalUrl)}&show_text=0&autoplay=1&mute=0&width=${e.width}`}" width="${e.width}" height="${e.height}" frameborder="0" webkitallowfullscreen mozallowfullscreen msallowfullscreen allowfullscreen></iframe>`}},native:{getVideoDataApiEndpoint(e){},getPosterImageApiEndpoint(e){},getIframe(e){return`<video width="${e.width}" height="${e.height}" autoplay controls><source src="${e.videoId}" /></video>`}},vimeo:{getVideoDataApiEndpoint(e){},getPosterImageApiEndpoint(e){return`/video/vimeo/${e}-poster-image`},getIframe(e){return`<iframe src="https://player.vimeo.com/video/${e.videoId}?autoplay=1#t=${e.startAt}" width="${e.width}" height="${e.height}" frameborder="0" webkitallowfullscreen mozallowfullscreen msallowfullscreen allowfullscreen></iframe>`}},youtube:{getVideoDataApiEndpoint(e){},getPosterImageApiEndpoint(e){return`/video/youtube/${e}-poster-image`},getIframe(e){return`<iframe src="https://www.youtube-nocookie.com/embed/${e.videoId}?autoplay=1&start=${e.startAt}" width="${e.width}" height="${e.height}" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" webkitallowfullscreen mozallowfullscreen msallowfullscreen allowfullscreen></iframe>`}}},b={name:"EmbettyVideo",extends:h,props:{width:{type:Number,required:!1,default:null},height:{type:Number,required:!1,default:null},type:{type:String,required:!0,validator(e){return e in o}},videoId:{type:String,required:!0,validator(e){return/^[a-zA-Z0-9_-]{6,}$/.test(e)||e.startsWith("http")}},startAt:{type:[Number,String],required:!1,default:0,validator(e){return typeof e=="number"?e%1===0&&e>=0:/^(?:(?:\d+h)?\d+m)?\d+s?$/.test(e)}},posterImageMode:{type:String,required:!1,default:null}},data(){return{activated:!1}},computed:{impl(){if(!(this.type in o))throw new Error(`Could not find video implementation for type ${this.type}. Please specify a valid video type.`);return o[this.type]},posterImageUrl(){return this._api(this.impl.getPosterImageApiEndpoint(this.videoId))},_posterImageMode(){return this.posterImageMode||this._embettyVueOptions.posterImageMode||"cover"},_startAt(){if(typeof this.startAt=="number")return this.startAt;const e=/^(?:(?:(\d+)h)?(\d+)m)?(\d+)s?$/,t=this.startAt.match(e);if(t){const a=t.map(l=>l===void 0?0:parseInt(l)),r=a[1],i=a[2],s=a[3];return r*3600+i*60+s}return 0},url(){return this._api(this.impl.getVideoDataApiEndpoint(this.videoId))},iframe(){return this.impl.getIframe({width:this.width||1600,height:this.height||900,videoId:this.videoId,startAt:this._startAt,serverData:this.data})}},methods:{activate(){this.activated=!0,this.$emit("activated")}}};var A=function(){var t=this,a=t._self._c;return a("div",{staticClass:"embetty-video",style:t.width===null?"":`width: ${t.width}px`},[t.activated?a("div",{staticClass:"wrapper",class:{"default-height":t.height===null},style:t.height===null?"":`height: ${t.height}px`,domProps:{innerHTML:t._s(t.iframe)}}):[a("button",{staticClass:"playbutton",attrs:{type:"button"},on:{click:t.activate}},[a("svg",{attrs:{xmlns:"http://www.w3.org/2000/svg",width:"72",height:"72",viewBox:"0 0 48 48",fill:"#fff"}},[a("path",{attrs:{d:"M24 4C12.95 4 4 12.95 4 24s8.95 20 20 20 20-8.95 20-20S35.05 4 24 4zm-4 29V15l12 9-12 9z"}})])]),a("div",{class:{poster:!0,"default-height":t.height===null,contain:t.posterImageMode==="contain"},style:[t.posterImageUrl?{backgroundImage:`url(${t.posterImageUrl})`}:{},t.height===null?{}:{height:`${t.height}px`}]}),a("a",{staticClass:"powered-by",attrs:{href:"https://www.heise.de/embetty",target:"_blank",rel:"noopener",title:"embetty - displaying remote content without compromising your privacy."}},[t._v(" powered by "),a("span",{staticClass:"embetty-logo",domProps:{innerHTML:t._s(t.embettyLogo)}})])]],2)},Z=[],$=n(b,A,Z);const k=$.exports,I={install(e,t={}){e.component("EmbettyTweet",v),e.component("EmbettyVideo",k),e.prototype._embettyVueOptions=t}};if(typeof window<"u"&&Object.prototype.hasOwnProperty.call(window,"Vue")){const e=document.querySelector("meta[data-embetty-server]"),t={serverUrl:e!==null?e.getAttribute("data-embetty-server"):void 0};window.Vue.use(I,t)}})();
