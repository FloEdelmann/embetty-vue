  ...
  var _sfc_main$1 = {
    ...
    computed: {
      ...
      media: function media() {
        ...
        var media2 = extended.media || [];
        return media2.map(function(m, idx) {
      ...
      createdAt: function createdAt() {
        var createdAt2 = this.data.created_at.replace(/\+\d{4}\s/, "");
        return new Date(createdAt2);
      },
      /**
    ...
    methods: {
      ...
      fitLinkDescription: function fitLinkDescription() {
        ...
        var sectionHeight = function sectionHeight2() {
