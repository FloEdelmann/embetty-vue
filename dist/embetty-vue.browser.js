...
(function (vue) {
  ...
  var isOneOf = function isOneOf(allowedValues) {
    return function (value) {
      if (!allowedValues.includes(value)) {
        return "value should be one of \"".concat(allowedValues.join('", "'), "\"");
      }
      return void 0;
    };
  };
  function vuePropValidator(userValidator) {
    for (var _len = arguments.length, typeValidators = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      typeValidators[_key - 1] = arguments[_key];
    }
    var validators = userValidator ? [].concat(typeValidators, [userValidator]) : typeValidators;
    ...
    return function (value) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (errorMessage) {
            console.warn("".concat(errorMessage, " (received: '").concat(String(value), "')"));
            return false;
          }
        }
      } catch (err) {
  ...
  var propOptionsGenerator = function propOptionsGenerator(type, userValidator) {
    for (var _len2 = arguments.length, typeValidators = new Array(_len2 > 2 ? _len2 - 2 : 0), _key2 = 2; _key2 < _len2; _key2++) {
      typeValidators[_key2 - 2] = arguments[_key2];
    }
    return {
      optional: {
        type: type,
        required: false,
        default: void 0,
        validator: vuePropValidator.apply(void 0, [userValidator].concat(typeValidators))
      },
      nullable: {
        type: type,
        required: false,
      ...
      withDefault: function withDefault(defaultValue) {
        return {
          type: type,
          required: false,
  ...
  var stringProp = function stringProp(validator) {
    return propOptionsGenerator(String, validator);
  };
  var booleanProp = function booleanProp(validator) {
    return propOptionsGenerator(Boolean, validator);
  };
  var numberProp = function numberProp(validator) {
    return propOptionsGenerator(Number, validator);
  };
  var getOneOfType = function getOneOfType(values) {
    var allowedTypes = _toConsumableArray(new Set(values.flatMap(function (value) {
      var _a;
  ...
  var oneOfProp = function oneOfProp(allowedValues, validator) {
    return propOptionsGenerator(getOneOfType(allowedValues), validator, isOneOf(allowedValues));
  };
  var oneOfObjectKeysProp = function oneOfObjectKeysProp(object, validator) {
    return oneOfProp(Object.keys(object), validator);
  };
  var oneOfTypesProp = function oneOfTypesProp(type, validator) {
    return propOptionsGenerator(type, validator);
  };
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              ...
              case 1:
                _context.n = 2;
                return window.fetch(_this.url);
              case 2:
                response = _context.v;
                _context.n = 3;
                return response.json();
              case 3:
                _this.data = _context.v;
                _this.fetched = true;
              case 4:
                return _context.a(2);
            }
  ...
  var _sfc_render$2 = null;
  var _sfc_staticRenderFns$2 = null;
  var __component__$2 = /* @__PURE__ */normalizeComponent(_sfc_main$2, _sfc_render$2, _sfc_staticRenderFns$2);
  var EmbettyEmbed = __component__$2.exports;
  var LINK_IMAGE_SIZE = 125;
  var MIN_WINDOW_WIDTH = 600;
  var MAX_TRUNCATION_ITERATIONS = 200;
  var _sfc_main$1 = vue.defineComponent({
    name: "EmbettyTweet",
    extends: EmbettyEmbed,
    props: {
      status: stringProp(function (statusId) {
        if (typeof statusId === "string" && /^\d{6,}$/.test(statusId)) {
          return void 0;
        }
    ...
    methods: {
      ...
      fitLinkDescription: function fitLinkDescription() {
        ...
        this.linkDescription = (_this$link$descriptio = this.link.description) !== null && _this$link$descriptio !== void 0 ? _this$link$descriptio : null;
        ...
        var _reduceLinkDescriptionLength = function reduceLinkDescriptionLength() {
          if (counter >= MAX_TRUNCATION_ITERATIONS || last === _this5.linkDescription) {
            return;
          }
          if (sectionHeight() - 2 <= imgHeight) {
            return;
          }
          last = _this5.linkDescription;
          _this5.linkDescription = _this5.linkDescription.replace(/\W*\s(\S)*$/, "…");
          counter++;
          _this5.$nextTick(_reduceLinkDescriptionLength);
        };
        this.$nextTick(_reduceLinkDescriptionLength);
      }
    }
  });
  var _sfc_render$1 = function render() {
    ...
    return _c("div", {
      ...
      attrs: {
        "href": "https://twitter.com/".concat(_vm.screenName),
        "target": "_blank",
        "rel": "noopener"
      }
      ...
      class: "media media-".concat(_vm.media.length)
  ...
  var FacebookVideo = {
    ...
    getIframe: function getIframe(videoData) {
      ...
      return "<iframe src=\"".concat(iframeSrc, "\" width=\"").concat(videoData.width, "\" height=\"").concat(videoData.height, "\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen msallowfullscreen allowfullscreen></iframe>");
    }
  };
  var NativeVideo = {
    /**
  ...
  var _sfc_main = vue.defineComponent({
    ...
    props: {
      ...
      videoId: stringProp(function (videoId) {
      ...
      startAt: oneOfTypesProp([Number, String], function (startAt) {
      ...
      _startAt: function _startAt() {
        ...
        if (timeMatch) {
          var timeNumbers = timeMatch.map(function (val) {
            return val === void 0 ? 0 : parseInt(val);
          });
  ...
  var _sfc_render = function render() {
    ...
    return _c("div", {
      ...
      style: _vm.width === null ? "" : "width: ".concat(_vm.width, "px")
    }, [_vm.activated ? _c("div", {
      staticClass: "wrapper",
      class: {
        "default-height": _vm.height === null
      },
      style: _vm.height === null ? "" : "height: ".concat(_vm.height, "px"),
      domProps: {
      ...
      style: [_vm.posterImageUrl ? {
        backgroundImage: "url(".concat(_vm.posterImageUrl, ")")
      } : {}, _vm.height === null ? {} : {
  ...
  var EmbettyPlugin = {
    ...
    install: function install(Vue2) {
      ...
      Vue2.component("EmbettyVideo", EmbettyVideo);
      Vue2.prototype._embettyVueOptions = options;
    }
  };
  if (typeof window !== "undefined" && Object.prototype.hasOwnProperty.call(window, "Vue")) {
    var _baseUrlMeta$getAttri;
    var baseUrlMeta = document.querySelector("meta[data-embetty-server]");
    var embettyVueOptions = {
      serverUrl: baseUrlMeta !== null ? (_baseUrlMeta$getAttri = baseUrlMeta.getAttribute("data-embetty-server")) !== null && _baseUrlMeta$getAttri !== void 0 ? _baseUrlMeta$getAttri : void 0 : void 0
    };
