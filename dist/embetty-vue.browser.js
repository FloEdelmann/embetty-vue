...
(function () {
  ...
  var _sfc_main$1 = {
    ...
    computed: {
      ...
      twitterUrl: function twitterUrl() {
        return "https://twitter.com/".concat(this.screenName, "/status/").concat(this.data.id_str);
      },
      /**
  ...
  var _sfc_main = {
    ...
    props: {
      ...
      type: stringProp(function (videoType) {
        if (videoType in videoImplementations) {
          return void 0;
        }
        return "Expected one of: ".concat(Object.keys(videoImplementations).join(", "));
      }).required,
  ...
  if (typeof window !== "undefined" && Object.prototype.hasOwnProperty.call(window, "Vue")) {
    ...
    var embettyVueOptions = {
      serverUrl: baseUrlMeta !== null ? baseUrlMeta.getAttribute("data-embetty-server") : void 0
    };
