...
const _sfc_main$1 = vue.defineComponent({
  ...
  props: {
    status: vueTsTypes.stringProp((statusId) => {
      if (typeof statusId === "string" && /^\d{6,}$/.test(statusId)) {
        return void 0;
      }
      return "Expected a valid Twitter status ID";
    }).required,
    answered: vueTsTypes.booleanProp().withDefault(false)
  },
  /**
...
const _sfc_main = vue.defineComponent({
  ...
  extends: EmbettyEmbed,
  props: {
    width: vueTsTypes.numberProp().nullable,
    height: vueTsTypes.numberProp().nullable,
    type: vueTsTypes.oneOfObjectKeysProp(videoImplementations).required,
    videoId: vueTsTypes.stringProp((videoId) => {
  ...
  computed: {
    ...
    _startAt() {
      ...
      if (timeMatch) {
        const timeNumbers = timeMatch.map((val) => val === void 0 ? 0 : parseInt(val));
...
var _sfc_render = function render2() {
  var _vm = this, _c = _vm._self._c;
  _vm._self._setupProxy;
  return _c("div", { staticClass: "embetty-video", style: _vm.width === null ? `` : `width: ${_vm.width}px` }, [_vm.activated ? _c("div", { staticClass: "wrapper", class: { "default-height": _vm.height === null }, style: _vm.height === null ? `` : `height: ${_vm.height}px`, domProps: { "innerHTML": _vm._s(_vm.iframe) } }) : [_c("button", { staticClass: "playbutton", attrs: { "type": "button" }, on: { "click": _vm.activate } }, [_c("svg", { attrs: { "xmlns": "http://www.w3.org/2000/svg", "width": "72", "height": "72", "viewBox": "0 0 48 48", "fill": "#fff" } }, [_c("path", { attrs: { "d": "M24 4C12.95 4 4 12.95 4 24s8.95 20 20 20 20-8.95 20-20S35.05 4 24 4zm-4 29V15l12 9-12 9z" } })])]), _c("div", { class: {
    "poster": true,
  ...
  ] }), _c("a", { staticClass: "powered-by", attrs: { "href": "https://www.heise.de/embetty", "target": "_blank", "rel": "noopener", "title": "embetty - displaying remote content without compromising your privacy." } }, [_vm._v(" powered by "), _c("span", { staticClass: "embetty-logo", domProps: { "innerHTML": _vm._s(_vm.embettyLogo) } })])]], 2);
};
