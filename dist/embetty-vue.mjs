...
var __vue_render__$1 = function() {
  ...
  return _c(
    "div",
    { class: { "embetty-tweet": true, answered: _vm.answered } },
    [
      _vm.fetched
        ? [
            _vm.isReply
              ? _c("embetty-tweet", {
                  attrs: { status: _vm.answeredTweetId, answered: true }
                })
              : _vm._e(),
            _c("header", [
              _c("img", { attrs: { src: _vm.profileImageUrl } }),
              _c("span", [
            ...
            _c("article", [
              _c("p", { domProps: { innerHTML: _vm._s(_vm.fullText) } }),
              _vm.media.length > 0
                ? _c(
                    "section",
                    ...
                    _vm._l(_vm.media, function(med) {
                      return _c(
                        ...
                        {
                          key: med.imageUrl,
                          attrs: { href: med.imageUrl, target: "_blank" }
                        },
                        [_c("img", { attrs: { src: med.imageUrl } })]
                      )
                    }),
                    0
                  )
              ...
              _vm.links.length > 0
                ? _c(
                    ...
                    [
                      _c("img", { attrs: { src: _vm.linkImageUrl } }),
                      _c(
                        "section",
                        { ref: "linkBody", staticClass: "link-body" },
                        [
                          _c("h3", [_vm._v(_vm._s(_vm.link.title))]),
                          _vm.linkDescription
                            ? _c("p", [_vm._v(_vm._s(_vm.linkDescription))])
                            : _vm._e(),
                          _vm.linkHostname
                            ? _c("span", [_vm._v(_vm._s(_vm.linkHostname))])
                            : _vm._e()
                        ]
                      )
                    ]
              ...
              _c(
                ...
                [
                  _c(
                    "time",
                    { attrs: { datetime: _vm.createdAt.toISOString() } },
                    [_vm._v(_vm._s(_vm.createdAt.toLocaleString()))]
                  ),
                  _vm._v(" via Twitter "),
                  _c(
                    "svg",
              ...
              _c(
                "a",
                {
                  ...
                  attrs: {
                    href:
                      "https://www.heise.de/embetty?wt_mc=link.embetty.poweredby",
                    target: "_blank",
                    rel: "noopener",
                    title:
                      "embetty - displaying remote content without compromising your privacy."
                  }
                },
                [
                  _vm._v(" powered by "),
                  _c("span", {
                    ...
                    domProps: { innerHTML: _vm._s(_vm.embettyLogo) }
                  })
                ]
              )
            ])
  ...
  return _c(
    ...
    [
      _vm.activated
        ? _c("div", {
            staticClass: "wrapper",
            class: { "default-height": _vm.height === null },
            style: _vm.height === null ? "" : "height: " + _vm.height + "px",
            domProps: { innerHTML: _vm._s(_vm.iframe) }
          })
        : [
            _c(
              "button",
...
var EmbettyPlugin = {
  ...
  install: function(Vue, options) {
    ...
    Vue.component('EmbettyVideo', __vue_component__);
    Vue.prototype._embettyVueOptions = options;
  }
};

export default EmbettyPlugin;
export { EmbettyPlugin, __vue_component__$1 as EmbettyTweet, __vue_component__ as EmbettyVideo };
