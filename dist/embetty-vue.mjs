...
const v = {
  ...
  methods: {
    ...
    fetchData: function() {
      if (!(typeof window > "u")) {
        var e = this;
        window.fetch(this.url).then(function(t) {
          return t.json();
        }).then(function(t) {
          e.data = t, e.fetched = !0;
        });
      }
    },
    /**
     ...
     */
    _api: function(e) {
      return e ? this._serverUrl + e : void 0;
    }
  }
}, g = null, w = null;
var y = /* @__PURE__ */ d(
...
const Z = {
  ...
  computed: {
    ...
    fullText: function() {
      var e = this;
      return this.data.full_text.replace(/(https:\/\/[^\s]+)/g, function(t) {
        return e.media.length > 0 && e.media[0].url === t ? "" : '<a href="' + t + '">' + t + "</a>";
      }).replace(/#(\w+)/g, function(t, a) {
        return '<a href="https://twitter.com/hashtag/' + a + '">' + t + "</a>";
      }).replace(/@(\w+)/g, function(t, a) {
        return '<a href="https://twitter.com/' + a + '">' + t + "</a>";
      });
    },
    /**
     ...
     */
    media: function() {
      var e = this, t = this.data.extended_entities || {}, a = t.media || [];
      return a.map(function(r, i) {
        return r.imageUrl = e.url + "-images-" + i, r;
      });
    },
    /**
     ...
     */
    createdAt: function() {
      var e = this.data.created_at.replace(/\+\d{4}\s/, "");
      return new Date(e);
    },
    /**
  ...
  mounted: function() {
    var e = this;
    this.$watch("fetched", function(t) {
      t && e.fitLinkDescription();
    }, {
      immediate: !0
    }), window && window.addEventListener("resize", function() {
      window.innerWidth < b || e.fitLinkDescription();
    });
  },
  methods: {
    /**
    ...
    fitLinkDescription: function() {
      if (!(!this.link || !window) && (this.linkDescription = this.link.description, !!this.linkDescription)) {
        var e = this.$refs.link, t = this.$refs.linkBody;
        if (e.clientWidth !== t.clientWidth) {
          var a = _, r = 0, i = "", n = window.getComputedStyle(e), s = function() {
            var u = parseFloat(n.getPropertyValue("margin-top")), m = parseFloat(n.getPropertyValue("margin-bottom")), f = parseFloat(n.getPropertyValue("height"));
            return f + u + m;
          }, l = this, c = function() {
            r >= 200 || i === this.linkDescription || s() - 2 <= a || (i = l.linkDescription, l.linkDescription = l.linkDescription.replace(/\W*\s(\S)*$/, "…"), r++, l.$nextTick(c));
          };
          this.$nextTick(c);
        }
      }
...
var A = function() {
  ...
  return a("div", { class: { "embetty-tweet": !0, answered: t.answered } }, [t.fetched ? [t.isReply ? a("embetty-tweet", { attrs: { status: t.answeredTweetId, answered: !0 } }) : t._e(), a("header", [a("img", { attrs: { src: t.profileImageUrl } }), a("span", [a("strong", [t._v(t._s(t.userName))]), a("a", { attrs: { href: `https://twitter.com/${t.screenName}`, target: "_blank", rel: "noopener" } }, [t._v("@" + t._s(t.screenName))])])]), a("article", [a("p", { domProps: { innerHTML: t._s(t.fullText) } }), t.media.length > 0 ? a("section", { class: `media media-${t.media.length}` }, t._l(t.media, function(r) {
    return a("a", { key: r.imageUrl, attrs: { href: r.imageUrl, target: "_blank" } }, [a("img", { attrs: { src: r.imageUrl } })]);
  }), 0) : t._e(), t.links.length > 0 ? a("a", { ref: "link", staticClass: "links", attrs: { href: t.link.url, target: "_blank", rel: "noopener" } }, [a("img", { attrs: { src: t.linkImageUrl } }), a("section", { ref: "linkBody", staticClass: "link-body" }, [a("h3", [t._v(t._s(t.link.title))]), t.linkDescription ? a("p", [t._v(t._s(t.linkDescription))]) : t._e(), t.linkHostname ? a("span", [t._v(t._s(t.linkHostname))]) : t._e()])]) : t._e(), a("a", { staticClass: "created-at", attrs: { href: t.twitterUrl, target: "_blank", rel: "noopener" } }, [a("time", { attrs: { datetime: t.createdAt.toISOString() } }, [t._v(t._s(t.createdAt.toLocaleString()))]), t._v(" via Twitter "), a("svg", { attrs: { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 400 400" } }, [a("path", { staticStyle: { fill: "#1da1f2" }, attrs: { d: "M153.62,301.59c94.34,0,145.94-78.16,145.94-145.94,0-2.22,0-4.43-.15-6.63A104.36,104.36,0,0,0,325,122.47a102.38,102.38,0,0,1-29.46,8.07,51.47,51.47,0,0,0,22.55-28.37,102.79,102.79,0,0,1-32.57,12.45,51.34,51.34,0,0,0-87.41,46.78A145.62,145.62,0,0,1,92.4,107.81a51.33,51.33,0,0,0,15.88,68.47A50.91,50.91,0,0,1,85,169.86c0,.21,0,.43,0,.65a51.31,51.31,0,0,0,41.15,50.28,51.21,51.21,0,0,1-23.16.88,51.35,51.35,0,0,0,47.92,35.62,102.92,102.92,0,0,1-63.7,22A104.41,104.41,0,0,1,75,278.55a145.21,145.21,0,0,0,78.62,23" } })])]), a("a", { staticClass: "powered-by", attrs: { href: "https://www.heise.de/embetty?wt_mc=link.embetty.poweredby", target: "_blank", rel: "noopener", title: "embetty - displaying remote content without compromising your privacy." } }, [t._v(" powered by "), a("span", { staticClass: "embetty-logo", domProps: { innerHTML: t._s(t.embettyLogo) } })])])] : t._e()], 2);
}, k = [], I = /* @__PURE__ */ d(
  Z,
  A,
  k
...
var C = {
   ...
   */
  getVideoDataApiEndpoint: function(e) {
    return "/video/facebook/" + e;
  },
  /**
   * @param {!string} videoId The ID of the video.
   * @returns {!string} The embetty-server API endpoint to get the poster image from.
   */
  getPosterImageApiEndpoint: function(e) {
    return "/video/facebook/" + e + "-poster-image";
  },
  /**
  ...
  getIframe: function(e) {
    var t = encodeURIComponent(e.serverData.canonicalUrl), a = "https://www.facebook.com/plugins/video.php?href=" + t + "&show_text=0&autoplay=1&mute=0&width=" + e.width;
    return '<iframe src="' + a + '" width="' + e.width + '" height="' + e.height + '" frameborder="0" webkitallowfullscreen mozallowfullscreen msallowfullscreen allowfullscreen></iframe>';
  }
}, M = {
  /**
   * @param {!string} videoId The ID of the video.
   ...
   */
  getIframe: function(e) {
    return '<video width="' + e.width + '" height="' + e.height + '" autoplay controls><source src="' + e.videoId + '" /></video>';
  }
}, E = {
  /**
   * @param {!string} videoId The ID of the video.
   ...
   */
  getPosterImageApiEndpoint: function(e) {
    return "/video/vimeo/" + e + "-poster-image";
  },
  /**
   * @param {!VideoData} videoData All data required to render the video iframe.
   * @returns {!string} The <iframe> playing the video.
   */
  getIframe: function(e) {
    return '<iframe src="https://player.vimeo.com/video/' + e.videoId + "?autoplay=1#t=" + e.startAt + '" width="' + e.width + '" height="' + e.height + '" frameborder="0" webkitallowfullscreen mozallowfullscreen msallowfullscreen allowfullscreen></iframe>';
  }
}, $ = {
  /**
   * @param {!string} videoId The ID of the video.
   ...
   */
  getPosterImageApiEndpoint: function(e) {
    return "/video/youtube/" + e + "-poster-image";
  },
  /**
   * @param {!VideoData} videoData All data required to render the video iframe.
   * @returns {!string} The <iframe> playing the video.
   */
  getIframe: function(e) {
    return '<iframe src="https://www.youtube-nocookie.com/embed/' + e.videoId + "?autoplay=1&start=" + e.startAt + '" width="' + e.width + '" height="' + e.height + '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"webkitallowfullscreen mozallowfullscreen msallowfullscreen allowfullscreen></iframe>';
  }
}, o = {
  facebook: C,
  native: M,
...
const U = {
  ...
  props: {
    ...
    videoId: {
       ...
       */
      validator: function(e) {
        return /^[a-zA-Z0-9_-]{6,}$/.test(e) || e.startsWith("http");
      }
    },
    startAt: {
      type: [Number, String],
       ...
       */
      validator: function(e) {
        return typeof e == "number" ? e % 1 === 0 && e >= 0 : /^(?:(?:\d+h)?\d+m)?\d+s?$/.test(e);
      }
    },
    posterImageMode: {
      type: String,
  ...
  computed: {
    ...
    _startAt: function() {
      if (typeof this.startAt == "number")
        return this.startAt;
      var e = /^(?:(?:(\d+)h)?(\d+)m)?(\d+)s?$/, t = this.startAt.match(e);
      if (t) {
        var a = t.map(function(s) {
          return s === void 0 ? 0 : parseInt(s);
        }), r = a[1], i = a[2], n = a[3];
        return r * 3600 + i * 60 + n;
      }
      return 0;
    },
    /**
  ...
  methods: {
     ...
     */
    activate: function() {
      this.activated = !0, this.$emit("activated");
    }
  }
};
var S = function() {
  var t = this, a = t._self._c;
  return a("div", { staticClass: "embetty-video", style: t.width === null ? "" : `width: ${t.width}px` }, [t.activated ? a("div", { staticClass: "wrapper", class: { "default-height": t.height === null }, style: t.height === null ? "" : `height: ${t.height}px`, domProps: { innerHTML: t._s(t.iframe) } }) : [a("button", { staticClass: "playbutton", attrs: { type: "button" }, on: { click: t.activate } }, [a("svg", { attrs: { xmlns: "http://www.w3.org/2000/svg", width: "72", height: "72", viewBox: "0 0 48 48", fill: "#fff" } }, [a("path", { attrs: { d: "M24 4C12.95 4 4 12.95 4 24s8.95 20 20 20 20-8.95 20-20S35.05 4 24 4zm-4 29V15l12 9-12 9z" } })])]), a("div", { class: {
    poster: !0,
    "default-height": t.height === null,
    contain: t.posterImageMode === "contain"
  }, style: [
    t.posterImageUrl ? { backgroundImage: `url(${t.posterImageUrl})` } : {},
    t.height === null ? {} : { height: `${t.height}px` }
  ] }), a("a", { staticClass: "powered-by", attrs: { href: "https://www.heise.de/embetty", target: "_blank", rel: "noopener", title: "embetty - displaying remote content without compromising your privacy." } }, [t._v(" powered by "), a("span", { staticClass: "embetty-logo", domProps: { innerHTML: t._s(t.embettyLogo) } })])]], 2);
}, V = [], T = /* @__PURE__ */ d(
  U,
  S,
  V
...
var q = {
  ...
  install: function(e, t) {
    t = t || {}, e.component("EmbettyTweet", x), e.component("EmbettyVideo", L), e.prototype._embettyVueOptions = t;
  }
};
export {
  q as EmbettyPlugin,
